        ...
        <div className="py-8">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div className="col-span-1 md:col-span-2">
              <h3 className="text-lg font-bold mb-4 text-white">DiabetEase</h3>
            ...
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li>
                  <Link href="/glucount" className="text-gray-200 hover:text-white transition-colors">
                    Glucount
                  </Link>
                </li>
                <li>
                  <Link href="/map" className="text-gray-200 hover:text-white transition-colors">
                    Map
                  </Link>
                </li>
                <li>
                  <Link href="/scanner" className="text-gray-200 hover:text-white transition-colors">
                    Scanner
                  </Link>
                </li>
              </ul>
